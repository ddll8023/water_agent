...
当前 M4 已实现知识库文档上传、列表、详情、删除和重新处理接口，基于 LangChain RecursiveCharacterTextSplitter 切片、DashScope Embedding 向量化、Chroma 持久化存储。文档预览等接口待后续开发。智能问答对话接口（流式 SSE）待下一阶段实现。
