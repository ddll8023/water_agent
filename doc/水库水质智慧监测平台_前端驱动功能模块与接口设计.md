...
| 07g | 知识图谱可视化 | 分析师、负责人 | M5 | ✅ 已实现（力导向图谱 + 节点探索 + 水库筛选 + 节点展开） |
...
| 节点搜索 | GET | /api/v1/graph/search | keyword, type? | 匹配节点列表 | ❌ 待补 |
| 节点详情 | GET | /api/v1/graph/node/{type}/{id} | — | 节点完整属性 | ❌ 待补 |
| 节点一跳扩展 | GET | /api/v1/graph/expand/{type}/{id} | depth? | 该节点相邻子图 | ❌ 待补 |
| 污染溯源路径 | GET | /api/v1/graph/trace | reservoir_code, indicator_code? | 溯源路径 nodes + edges | ❌ 待补 |
